  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Understand the limitations and responsibilities of content on VoiceInfo."
        />
      </Helmet>
      <div className="disclaimer-page">
        <div className="disclaimer-page-container">
          <motion.div
            className="disclaimer-page-card"
            variants={childVariants}
            initial="initial"
            animate="animate"
          >
            <motion.h2 className="disclaimer-page-title" variants={childVariants}>
              Disclaimer
            </motion.h2>
            <motion.div variants={childVariants} className="disclaimer-page-content">
              ...
              <p>
                ...
                <br />
                Email: <a href="mailto:voiceinfos01@gmail.com">voiceinfos01@gmail.com</a>
                <br />
              </p>
            </motion.div>
          </motion.div>
