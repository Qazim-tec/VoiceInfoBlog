  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Learn how VoiceInfo collects, uses, and protects your personal information."
        />
      </Helmet>
      <div className="privacy-page">
        <div className="privacy-page-container">
          <motion.div
            className="privacy-page-card"
            variants={childVariants}
            initial="initial"
            animate="animate"
          >
            <motion.h2 className="privacy-page-title" variants={childVariants}>
              Privacy Policy
            </motion.h2>
            <motion.div variants={childVariants} className="privacy-page-content">
